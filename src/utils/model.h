...
public:
    ...
    const std::vector<int> &get_tmp_facet_vrt() const { return facet_vrt; }
    const std::vector<int> &get_tmp_facet_tex() const { return facet_tex; }
    const std::vector<int> &get_tmp_facet_nrm() const { return facet_nrm; }
};
